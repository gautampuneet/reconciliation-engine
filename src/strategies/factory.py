...
from strategies.aggregate import AggregateMatchStrategy
...
class StrategyFactory:
    ...
    @classmethod
    def create_aggregate_strategy(cls) -> AggregateMatchStrategy:
        # Aggregate reconciliation requires exact equality of quantized sums.
        return AggregateMatchStrategy(amount_tolerance=Decimal("0"))
